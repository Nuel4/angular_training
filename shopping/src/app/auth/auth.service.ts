...
export class AuthService{
    ...
    authLogin(){
        ...
        const loadedUser = new User(userData.email ,userData.id ,userData._token,
            ...
            if(loadedUser.token){
               ...
               this.store.dispatch(new AuthActions.AuthenticateSucess({ email :loadedUser.email ,
   ...
   // const user =new User(email ,userId,token ,expirationDate);
        ...
        //this.user.next(user);
        const user = new User(email ,userId ,token ,expirationDate);
        this.store.dispatch( new AuthActions.AuthenticateSucess({email :email ,userId :userId , token :token ,expirationDate :expirationDate}))
